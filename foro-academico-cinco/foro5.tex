% Archivo principal. No compilado, por indicación del estudiante.
% Overleaf: subir main.tex y referencias.bib al mismo proyecto.
% Compilador: pdfLaTeX. Bibliografía: Biber (gestionado por Overleaf).
% Secuencia local: pdflatex main; biber main; pdflatex main; pdflatex main.
% Extensión diseñada para 2--4 páginas; verificar paginación al compilar.
